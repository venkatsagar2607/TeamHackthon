...
const FacebookIcon = () => (
    <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
    >
        <path d="M14 13.5h2.5l1-4H14v-2c0-1.03 0-2 2-2h1.5V2.14c-.326-.043-1.557-.14-2.857-.14C11.928 2 10 3.64 10 6.7v2.8H7v4h3V22h4v-8.5z" />
    </svg>
);
    ...
    return (
        <div className="relative flex h-screen flex-col md:flex-row font-inter bg-[#100427] text-white overflow-hidden">
            ...
            <div className="relative z-10 w-full md:w-1/2 flex items-center justify-center p-8">
                <div className="max-w-md w-full space-y-6 bg-black/10 backdrop-blur-md p-8 rounded-2xl shadow-2xl">
                    <div className="text-center md:text-left">
                        <h2 className="text-4xl font-bold">SIGN IN</h2>
                        <p className="mt-2 text-gray-400">Sign in with email address</p>
                    </div>
