                ...
                <div className="max-w-md w-full bg-black/10 backdrop-blur-md p-8 md:p-10 rounded-2xl shadow-2xl space-y-6">
                    ...
                    <form className="space-y-5" onSubmit={handleSignup}>
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full py-3 font-semibold text-white bg-gradient-to-r from-blue-500 to-purple-600 rounded-lg shadow-lg hover:from-blue-600 hover:to-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-300"
                        >
