...
export default function Profile() {
    const [formData, setFormData] = useState({
        ...
        phone: "+91 9876543210",
        dob: "2000-05-12",
        address1: "Flat 101, Sunrise Residency",
        address2: "Madhapur Main Road",
        city: "Hyderabad",
        state: "Telangana",
        country: "India",
        pincode: "500081",
            ...
            <div className="relative z-10 max-w-6xl mx-auto px-6 py-10 grid md:grid-cols-3 gap-8">
                ...
                <div className="col-span-1 bg-white/10 backdrop-blur-md border border-purple-800/40 rounded-2xl shadow-2xl p-8 flex flex-col items-center text-center">
                    ...
                    <p className="text-sm text-gray-500 flex items-center justify-center gap-1 mt-1">
                        <MapPin size={14} /> {formData.city}, {formData.state}
                    </p>
                    ...
                    <div className="mt-8 space-y-3 w-full text-left text-sm">
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-gray-400">@smartcity</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-gray-400">@venkata</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-gray-400">@venkata_sagar</span>
                        </div>
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <span className="text-gray-400">@vsagar</span>
                        </div>
                    </div>
                </div>
                ...
                <div className="col-span-2 bg-white/10 backdrop-blur-md border border-purple-700/40 rounded-2xl shadow-2xl p-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm mb-1 text-gray-300">Address Line 2</label>
                                <input
                                    type="text"
                                    name="address2"
                            ...
                            <div>
                                <label className="block text-sm mb-1 text-gray-300">Pincode</label>
                                <input
                                    type="text"
                                    name="pincode"
